...
return response.text().then(text => {
        ...
        .then(similars => {
            ...
            similars.data.forEach(similar => {
                ...
                <a class="story" style="width: auto;" href="read-publication.html?id=${similar.id}">
                        <div class="sim-img">
                            <img src="${similar.image}" style="display: block; width: 100%; height: 180px;">
                        </div>
        ...
        const imgPath = artData.image;
        
            
                container.style.backgroundImage = `linear-gradient(0deg, rgba(18, 54, 121, 0.50) 0%, #123679 100%), url('${imgPath}')`;
